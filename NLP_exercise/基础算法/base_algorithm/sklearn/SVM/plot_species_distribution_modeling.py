...
def create_species_bunch(species_name, train, test, coverages, xgrid, ygrid):
	"""
		...
		this will use the test/train record arrays to extract the data spe
		
		cific to the given species name
	"""
	...
	for label, pts in points.items():
		# choose the points associated with the desired species
...
def plot_species_distribution(species = ("bradpus_variegatus_0", "microryzomys_minutus_0")):
	"""
